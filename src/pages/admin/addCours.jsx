...
export default function AddCours() {
  ...
  const courseMap = {
    "1-Software enginner": [
      { value: "introAlgo", label: "Introduction to Algorithms" },
      { value: "math1", label: "Mathematics I" },
    ],
    "2-Software enginner": [
      { value: "oop", label: "Object Oriented Programming" },
      { value: "web1", label: "Web Development I" },
    ],
    "1-Computer enginner": [
      { value: "circuits", label: "Circuit Fundamentals" },
      { value: "logic", label: "Digital Logic" },
    ],
    "2-Computer enginner": [
      { value: "micro", label: "Microcontrollers" },
      { value: "arch", label: "Computer Architecture" },
    ],
  };

  useEffect(() => {
    const key = `${year}-${department}`;
    setCoursesState(courseMap[key] || []);
    setSelectedCourse("");
  }, [year, department]);
  ...
  return (
    <div>
      ...
      <div className="p-14 sm:ml-64 mt-10">
        <div className=" mb-8">
          <h1 className="text-4xl font-bold">Add cours</h1>
        </div>
        <form>
