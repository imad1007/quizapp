...
export default function AddQcm() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("Submitted QCM:", qcmData);
    // You can replace this with an API call to save the QCM
  };
  ...
  return (
    <div>
      ...
      <div className="p-14 sm:ml-64 mt-10">
        <div className="mb-8">
          <h1 className="text-4xl font-bold">Add QCM Question</h1>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <option value="US">Mathematics</option>
            <option value="CA">Introduction to algorithms</option>
            <option value="FR">Introduction to software engineer </option>
